...
!function (e, t) {
    ...
    var t = {
        ...
        styles: function () {
            return this[0]
                ? ee.getComputedStyle(this[0], null)
                : {}
        }
    };
    Object
    ...
    var a,
        ...
        ae = (s = f.createElement("div"), {
            touch: ee.Modernizr && !0 === ee.Modernizr.touch || !!(
                0 < ee.navigator.maxTouchPoints || "ontouchstart" in ee || ee.DocumentTouch && f instanceof ee.DocumentTouch
            ),
            pointerEvents: !!(
                ee.navigator.pointerEnabled || ee.PointerEvent || "maxTouchPoints" in ee.navigator && 0 < ee.navigator.maxTouchPoints
            ),
            ...
            transforms3d: ee.Modernizr && !0 === ee.Modernizr.csstransforms3d || (
                a = s.style,
    ...
    e.prototype.emit = function () {
        ...
        return r.eventsListeners && (
            s = "string" == typeof e[0] || Array.isArray(e[0])
    ...
    var v = {
        ...
        unsetGrabCursor: function () {
            ae.touch || this.params.watchOverflow && this.isLocked || (
        ...
        y = {
            ...
            events: {
                attachEvents: function () {
                    ...
                    e.onTouchStart = function (e) {
                        ...
                        if (!t.animating || !i.preventInteractionOnTransition) {
                            ...
                            if (
                                ...
                                if (i.noSwiping && I(r.target).closest(
                                    i.noSwipingSelector
                                        ? i.noSwipingSelector
                                        : "." + i.noSwipingClass
                                )[0]) 
                                    ...
                                    if (!l || !(n <= d || n >= ee.screen.width - d)) {
                                        if (
                                            ...
                                            f.activeElement && I(f.activeElement).is(a.formElements) && f.activeElement !== r.target && f
                                                .activeElement
                                                .blur();
                    ...
                    if (ae.touch || !ae.pointerEvents && !ae.prefixedPointerEvents) {
                        if (ae.touch) {
                            var o = !(
                                "touchstart" !== a.start || !ae.passiveListener || !t.passiveListeners
                            ) && {
                                passive: !0,
                                capture: !1
                            };
                ...
                detachEvents: function () {
                    ...
                    if (ae.touch || !ae.pointerEvents && !ae.prefixedPointerEvents) {
                        if (ae.touch) {
                            var o = !(
                                "onTouchStart" !== a.start || !ae.passiveListener || !t.passiveListeners
                            ) && {
                                passive: !0,
                                capture: !1
                            };
            ...
            classes: {
                addClasses: function () {
                    ...
                    g.ios && s.push("ios"),
                    (ie.isIE || ie.isEdge) && (ae.pointerEvents || ae.prefixedPointerEvents) && s.push(
                        "wp8-" + a.direction
                    ),
        ...
        T = function (u) {
            function h() {
                for (var e, t, s, a = [], i = arguments.length; i--;) 
                    a[i] = arguments[i];
                s = (
                    s = 1 === a.length && a[0].constructor && a[0].constructor === Object
                        ? a[0]
                        : (t = (e = a)[0], e[1])
                ) || {},
                s = te.extend({}, s),
            ...
            h.prototype.changeDirection = function (a, e) {
                ...
                return (a = a || (
                    "horizontal" === i
                        ? "vertical"
                        : "horizontal"
                )) === i || "horizontal" !== a && "vertical" !== a || (
                    t.$el.removeClass(
                        "" + t.params.containerModifierClass + i + " wp8-" + i
                    ).addClass("" + t.params.containerModifierClass + a),
                    (ie.isIE || ie.isEdge) && (ae.pointerEvents || ae.prefixedPointerEvents) && t.$el.addClass(
                    ...
                    t.isHorizontal()
                        ...
                        : (33 !== s && 34 !== s && 38 !== s && 40 !== s || (
                            i.preventDefault
                                ? i.preventDefault()
                                : i.returnValue = !1
                        ), 34 !== s && 40 !== s || t.slideNext(), 33 !== s && 38 !== s || t.slidePrev()),
                    t.emit("keyPress", s)
                }
            },
            enable: function () {
    ...
    var O = {
        ...
        B = {
            ...
            enable: function () {
                ...
                if (!t.enabled) {
                    t.enabled = !0;
                    var a = !(
                        "touchstart" !== e.touchEvents.start || !ae.passiveListener || !e.params.passiveListeners
                    ) && {
                        passive: !0,
                        capture: !1
                    };
        ...
        F = {
            ...
            destroy: function () {
                this.params.history.replaceState || ee.removeEventListener(
                    "popstate",
        ...
        R = {
            ...
            init: function () {
                ...
                if (!(!e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled)) {
                    ...
                    e.params.hashNavigation.watchState && I(ee).on(
                        "hashchange",
            ...
            destroy: function () {
                this.params.hashNavigation.watchState && I(ee).off(
                    "hashchange",
            ...
            setTranslate: function () {
                ...
                for (var h = 0; h < s.length; h += 1) {
                    ...
                    if (
                        ...
                        0 === E.length && (E = I('<div class="swiper-slide-shadow-' + (
                            p
                                ? "left"
                                : "top"
                        ) + '"></div>'), v.append(E)),
                        0 === S.length && (S = I('<div class="swiper-slide-shadow-' + (
                            p
                                ? "right"
                                : "bottom"
                        ) + '"></div>'), v.append(S)),
                ...
                var $ = ie.isSafari || ie.isUiWebView
                    ? -l / 2
                    : 0;
            ...
            setTranslate: function () {
                for (
                    ...
                    if (
                        ...
                        0 === p.length && (p = I('<div class="swiper-slide-shadow-' + (
                            e.isHorizontal()
                                ? "left"
                                : "top"
                        ) + '"></div>'), s.append(p)),
                        0 === c.length && (c = I('<div class="swiper-slide-shadow-' + (
                            e.isHorizontal()
                                ? "right"
                                : "bottom"
                        ) + '"></div>'), s.append(c)),
        ...
        _ = {
            init: function () {
                ...
                t.swiper instanceof a
                    ? (e.thumbs.swiper = t.swiper, te.extend(e.thumbs.swiper.originalParams, {
                        watchSlidesProgress: !0,
                        slideToClickedSlide: !1
        ...
        Z = [
            ...
            D, {
                ...
                on: {
                    ...
                    click: function (e) {
                        var t,
                            ...
                            s = i.$nextEl,
                            r = i.$prevEl;
                        !a.params.navigation.hideOnClick || I(e.target).is(r) || I(e.target).is(s) || (
                            s
                ...
                on: {
                    ...
                    click: function (e) {
                        var t = this;
                        t.params.pagination.el && t.params.pagination.hideOnClick && 0 < t.pagination.$el.length && !I(
                            e.target
